        ...
        <rdf:RDF>
            ...
            <xsl:for-each select="//rdf:Description">
                ...
                <skos:Concept rdf:about="{$id}">
                    ...
                    -->
                    <xsl:for-each
                        select="exslt:node-set($lang)/lang/rdf:RDF/rdf:Description[@rdf:about=$id]">
                        <xsl:variable name="l" select="../@xml:lang"/>

                        <xsl:if
                            test="normalize-space(skos:prefLabel)!='' and string-length(skos:prefLabel) &lt; $maxStringLength">

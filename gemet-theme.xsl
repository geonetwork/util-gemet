...
-->
    ...
    <xsl:template match="/">
        <rdf:RDF>
            ...
            <xsl:variable name="lang">
                <lang>
                    <xsl:for-each select="//locale">
                        <xsl:message>Lang:<xsl:value-of select="."/></xsl:message>
            ...
            <xsl:for-each select="exslt:node-set($lang)//rdf:RDF[position()=last()]/gemet:Theme">
                ...
                <skos:Concept rdf:about="{$id}">
                    ...
                    -->
                    <xsl:for-each select="exslt:node-set($lang)//gemet:Theme[@rdf:about=$id]">
